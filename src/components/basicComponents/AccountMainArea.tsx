    ...
    <>
      <Box>
        <div>
          ...
          <p className="text-3xl font-bold text-color-004">{name}</p>
        </div>
        <p className="text-2xl font-bold text-color-004 mt-7">
          잔액{" "}
          <span className="text-color-002">{balance.toLocaleString()}원</span>
        </p>
        <div className="flex flex-row gap-x-4 mt-5">
          <button className="basis-1/2 h-10 bg-color-001 rounded-md text-xl font-bold text-color-004">
            보내기
          </button>
          <button className="basis-1/2 h-10 bg-color-001 rounded-md text-xl font-bold text-color-004">
            채우기
